...
public class Verify_logout {
	...
	public static void main(String[] args) {
       ...
       driver.get("https://www.saucedemo.com/"); 
		...
		WebElement product_page = driver.findElement( By.xpath("//a[@id=\"logout_sidebar_link\"]"));
		product_page.click();
		
		WebElement log_out = driver.findElement( By.xpath( "//a[@id=\"logout_sidebar_link\"]"));
		log_out.click();
		
		  if (driver.getTitle().contains("Login Page"))
		  {  
	            System.out.println("User successfully logged out and redirected to the login page.");
	        }
		  else
	        {
	        	  System.out.println("User unsuccessfully logged out and  NOT redirected to the login page.");  
	        }
